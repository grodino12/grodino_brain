...
compiled: 2026-05-10
inputs:
  - FY2023 10-K through FY2025 10-K + all 10-Qs Q1 2023–Q3 2025
  - All earnings transcripts Q3 2018–Q1 2026 (30 calls)
  - Pepsi M&A call (Aug 1 2022), Alani Nu modeling call (May 28 2025)
  - Q4 2025 press release + transcript + CAGNY Feb 2026 deck
  - Q1 2026 earnings call (May 7 2026)
purpose: Revenue forecasting drivers + backward-looking trend signal
---
...
- Adj SG&A 26.4% (vs 31.8% Q4 2025)
- Adj EBITDA $195M / 24.9% margin (+370bps YoY)
- GAAP NI $110M (vs $44M PY)

**Forward framing from the call:**
- Q2 2026 GM "sidestep"; Q3/Q4 stair-step toward low-50s
- Mid-50s GM target moved from "near term" → 2027/2028 (per Langhans)
- Aluminum/Midwest premium + LME pressure flagged; "fully locked on aluminum conversion" + extending coverage into 2027/2028
- Second NC manufacturing line begins producing 2H 2026, full benefit 2027
- Buyback: $24.1M / 700K shares Q1; $236.1M remaining under $300M (Nov 2025) auth

**Key narrative items:**
- **$50M Alani synergies already captured** — Fieldly: "we have captured the approximately $50 million in synergies we outlined at our modeling call last May." Notably ahead of the "$4.2M/month from April 2026" ramp Langhans guided to in May 2025.
- **Portfolio share 20.9%** through 4-wk ending April 12 (up from 20% Q4 2025)
- **Spain launched via Suntory** (not Pepsi); Portugal next via Suntory
- **Eric Hanson first call appearance** as President & COO
- **Aston Martin Aramco F1 multi-year** global energy partner
- **Alani revenue bridge** mgmt provided: $198M Q1'25 RTD US baseline → +85% scanner-clean → $340M organic implied → $368M reported with non-US/Canada add ($28M) and DSD-mix lift

---

## Part 2 — FY2026 revenue forecast scaffolding
...
- Female 18–24 2× more likely to buy energy multiple times/week
- Hispanic +10.6% trip growth (#1 by demographic)
- 51% of energy growth from frequency increases
- 32% drinking on more occasions
- 52% of CELSIUS repeaters purchase 5×+ (+7% vs Q4 2024)
...
## Part 3 — Backward-looking trends worth digging deeper into

### Tier 1: highest forecast/modeling weight

#### 1. Distributor termination cycle is the recurring structural event — 3 iterations now, each ~10× larger

| Date | Event | $ Charge | Funding | Treatment |
|---|---|---|---|---|
| 2018 | Territorial dispute settlement | ~$1M | CELH cash | One-time SG&A |
...
### SEC filings
`C:\Users\rodin\Desktop\Brain\Sources\CELH\{period}\filings\CELH_{date}_{form}.htm`
- FY2023 10-K, FY2024 10-K, FY2025 10-K
- 10-Qs: Q1 2023 → Q3 2025 (12 quarters)

### Earnings transcripts
`C:\Users\rodin\Desktop\Brain\Sources\CELH\{period}\transcripts\`
- Q3 2018 (`2018-11-09`) → Q1 2026 (`2026-05-07`) — 30 earnings calls

### M&A and special calls
- Pepsi M&A call: `2022-Q1\transcripts\2022-08-01_CELH_MergerAcquisition.pdf`
...
### Model artifacts
- `Knowledge\Model Outputs\CELH\CELH_model.xlsx` (workbook)
- `Knowledge\Model Schema\Ticker Libraries\CELH\Financial Statements\` (config, ledger, validated_*, .cache)
