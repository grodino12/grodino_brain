...
_Last updated: 2026-04-18 16:59 Eastern Daylight Time. Dates from yfinance; times labeled **BMO** (before market open), **AMC** (after market close), or **Intraday**. Audio and Transcript columns reflect whether sources for the **last** earnings release exist under `Brain/Sources/{TICKER}/`. ✅ = present, ❌ = missing, — = not applicable._

| Ticker | Company                     | Last Earnings    | Next Earnings    | Audio | Transcript | IR Page                                |
| ------ | --------------------------- | ---------------- | ---------------- | ----- | ---------- | -------------------------------------- |
| PM     | Philip Morris International | 2026-02-06 (BMO) | 2026-04-22 (BMO) | ❌     | ❌          | https://www.pmi.com/investor-relations |
